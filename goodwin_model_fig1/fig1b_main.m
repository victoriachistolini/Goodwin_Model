...
[t,z] = ode15s(@goodwin,0:0.1:1000, y,odeset('MaxStep',0.1),params,x_fun,num_cells,2,0.005);
   
% determine FRP
p_mean = mean(z(9000:10000,1:num_cells),2);
per = getPeriod(t(9000:10000), p_mean);
...
figure;
plot( t(9000:10000), z(9000:10000,1:num_cells));

hold on;
plot( t(9000:10000), p_mean,'LineWidth',8);