...
[t,z] = ode15s(@goodwin,0:0.1:8000, y,odeset('MaxStep',0.1),params,x_fun,num_cells,2);
   
% determine FRP
p_mean = mean(z(78000:80000,1:num_cells),2);
per = getPeriod(t(78000:80000), p_mean);
   

figure;
plot( t(78000:80000), z(78000:80000,1:num_cells));

hold on;
plot( t(78000:80000), p_mean,'LineWidth',8);