...
% Conditions: 
% 100% self-sustained cells for the entire VL
% only VL cells are light-sensitive.
% 70% self-sustained for DM
...
num_dm_damped = round(0.7*num_dm,0)-1;
num_dm_sustained = round(0.3*num_dm,0);
...
% determine FRP
p_vl_mean = mean(z(18000:20000,1:num_vl),2);
